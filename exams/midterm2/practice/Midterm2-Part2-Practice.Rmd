...
## create bins and plot the mean and variance of g

### plot the jitter points in the same plot

ggplot(dd, aes(x = avg.score.prev, y = score)) +
  geom_point(alpha = 0.05) +
  geom_errorbar(data = ddd, 
                aes(x = as.numeric(bin), 
                    ymin = mean.score - sqrt(var.score), 
                    ymax = mean.score + sqrt(var.score)), 
                width = 1) 
