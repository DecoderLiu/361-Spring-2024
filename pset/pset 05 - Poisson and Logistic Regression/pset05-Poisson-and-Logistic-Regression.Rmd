...
Perform some data exploration and visualization that helps you learn about the data, with a focus on prediction `landcover`. Discuss any notable observations. 
...
Perform some data exploration and visualization that helps you learn about the data, with a focus on prediction `landcover`. Discuss any notable observations. Which `landcover` types will be harder/easier to classify based on what you learned?
